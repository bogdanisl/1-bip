            ...
            ListFooterComponent={
                <TouchableOpacity
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <FontAwesome name="feed" size={26} color={theme.whiteText} />
                        <Text style={[styles.cityName, { color: theme.whiteText, paddingLeft: 15 }]}>{t('change_bip_connection')}</Text>
                    </View>
                    <MaterialIcons name='chevron-right' size={26} color={theme.whiteText} />
                </TouchableOpacity>
            }
